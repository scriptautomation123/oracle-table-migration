...
PROMPT ================================================================
PROMPT Table: APP_DATA_OWNER.APP_CACHE
PROMPT ================================================================
...
WHERE owner = 'APP_DATA_OWNER'
  AND table_name IN ('APP_CACHE', 'APP_CACHE_OLD')
ORDER BY table_name;
...
PROMPT
PROMPT Skipping Step 70: Old table kept as APP_DATA_OWNER.APP_CACHE_OLD
PROMPT You can drop it later with: DROP TABLE APP_DATA_OWNER.APP_CACHE_OLD PURGE;
...
PROMPT ================================================================
PROMPT New partitioned table: APP_DATA_OWNER.APP_CACHE
PROMPT Backup table: APP_DATA_OWNER.APP_CACHE_OLD
PROMPT ================================================================
