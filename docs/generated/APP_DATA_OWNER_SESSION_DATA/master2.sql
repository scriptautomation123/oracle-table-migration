...
WHERE owner = 'APP_DATA_OWNER'
  AND table_name IN ('SESSION_DATA', 'SESSION_DATA_OLD')
ORDER BY table_name;
...
PROMPT
PROMPT Skipping Step 70: Old table kept as APP_DATA_OWNER.SESSION_DATA_OLD
PROMPT You can drop it later with: DROP TABLE APP_DATA_OWNER.SESSION_DATA_OLD PURGE;
...
PROMPT ================================================================
PROMPT New partitioned table: APP_DATA_OWNER.SESSION_DATA
PROMPT Backup table: APP_DATA_OWNER.SESSION_DATA_OLD
PROMPT ================================================================
