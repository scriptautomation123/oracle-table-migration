...
-- ==================================================================
-- DELTA LOAD: APP_DATA_OWNER.SESSION_DATA_NEW
-- ==================================================================
...
DECLARE
    ...
    v_table_name VARCHAR2(128) := 'APP_DATA_OWNER.SESSION_DATA';
    v_sql VARCHAR2(4000);
BEGIN
...
MERGE /*+ PARALLEL(4) */ INTO APP_DATA_OWNER.SESSION_DATA_NEW tgt
USING (
    SELECT CREATED_AT, LAST_ACCESS, USER_ID, SESSION_ID
...
WHEN NOT MATCHED THEN
    INSERT (CREATED_AT, LAST_ACCESS, USER_ID, SESSION_ID)
    VALUES (CREATED_AT, LAST_ACCESS, USER_ID, SESSION_ID);
