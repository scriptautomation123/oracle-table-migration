...
-- ==================================================================
-- DROP OLD TABLE: APP_DATA_OWNER.JOB_QUEUE_OLD
-- ==================================================================
...
PROMPT ================================================================
PROMPT Table to drop: APP_DATA_OWNER.JOB_QUEUE_OLD
...
BEGIN
    ...
    IF v_table_exists = 0 THEN
        DBMS_OUTPUT.PUT_LINE('Table APP_DATA_OWNER.JOB_QUEUE_OLD does not exist - nothing to drop');
        RETURN;
    END IF;
    ...
    IF v_migration_table_exists = 0 THEN
        DBMS_OUTPUT.PUT_LINE('ERROR: Migrated table APP_DATA_OWNER.JOB_QUEUE not found!');
    ...
    EXECUTE IMMEDIATE 'SELECT COUNT(*) FROM APP_DATA_OWNER.JOB_QUEUE_OLD' INTO v_old_row_count;
    EXECUTE IMMEDIATE 'SELECT COUNT(*) FROM APP_DATA_OWNER.JOB_QUEUE' INTO v_new_row_count;
...
PROMPT Dropping table APP_DATA_OWNER.JOB_QUEUE_OLD...
DROP TABLE APP_DATA_OWNER.JOB_QUEUE_OLD PURGE;

PROMPT ✓ Table APP_DATA_OWNER.JOB_QUEUE_OLD dropped successfully
...
BEGIN
    ...
    IF v_table_count = 0 THEN
        DBMS_OUTPUT.PUT_LINE('✓ Confirmed: Table APP_DATA_OWNER.JOB_QUEUE_OLD successfully removed');
    ELSE
...
PROMPT ================================================================
PROMPT Dropped: APP_DATA_OWNER.JOB_QUEUE_OLD
PROMPT Active table: APP_DATA_OWNER.JOB_QUEUE
