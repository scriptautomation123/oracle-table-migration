...
-- =====================================================================
-- Creates various table types to test schema-driven migration system
-- Includes: Non-partitioned, RANGE, LIST, HASH, INTERVAL, Composite partitioning
-- Features: Identity columns, LOBs, complex indexes, constraints, foreign keys, 
--          check constraints, composite indexes, referential integrity
-- 
-- This DDL creates a realistic Oracle schema with all types of constraints
-- to fully test the schema-driven migration system

-- Connect as APP_DATA_OWNER
-- ALTER SESSION SET CURRENT_SCHEMA = APP_DATA_OWNER;
...
BEGIN
    FOR r IN (SELECT table_name FROM user_tables 
              WHERE table_name IN ('TRANSACTION_LOG', 'ORDER_DETAILS', 'AUDIT_LOG', 
                                   'USER_SESSIONS', 'CUSTOMER_REGIONS', 'SALES_HISTORY',
                                   'PRODUCTS', 'CUSTOMERS', 'SALES_REPS', 'REGIONS')) LOOP
        EXECUTE IMMEDIATE 'DROP TABLE ' || r.table_name || ' CASCADE CONSTRAINTS PURGE';
        DBMS_OUTPUT.PUT_LINE('Dropped table: ' || r.table_name);
    END LOOP;
EXCEPTION
    WHEN OTHERS THEN 
        DBMS_OUTPUT.PUT_LINE('Some tables may not exist - proceeding...');
END;
/
...
CREATE TABLE SALES_REPS (
    ...
    HIRE_DATE DATE DEFAULT SYSDATE NOT NULL
        CONSTRAINT CHK_REPS_HIRE_DATE CHECK (HIRE_DATE <= SYSDATE),
...
CREATE TABLE SALES_HISTORY (
    ...
    SALE_DATE DATE NOT NULL
        CONSTRAINT CHK_SALES_DATE CHECK (SALE_DATE <= SYSDATE),
...
-- GATHER STATISTICS
-- ==========================================
EXEC DBMS_STATS.GATHER_SCHEMA_STATS('APP_DATA_OWNER');
...
PROMPT ====================================
PROMPT Oracle Comprehensive Test DDL Complete
PROMPT ====================================
...
PROMPT ====================================
PROMPT Ready for schema-driven migration testing!
PROMPT ====================================