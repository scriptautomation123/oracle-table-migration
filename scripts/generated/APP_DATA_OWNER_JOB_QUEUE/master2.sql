...
PROMPT ================================================================
PROMPT Table: APP_DATA_OWNER.JOB_QUEUE
PROMPT ================================================================
...
WHERE owner = 'APP_DATA_OWNER'
  AND table_name IN ('JOB_QUEUE', 'JOB_QUEUE_OLD')
ORDER BY table_name;
...
PROMPT
PROMPT Skipping Step 70: Old table kept as APP_DATA_OWNER.JOB_QUEUE_OLD
PROMPT You can drop it later with: DROP TABLE APP_DATA_OWNER.JOB_QUEUE_OLD PURGE;
...
PROMPT ================================================================
PROMPT New partitioned table: APP_DATA_OWNER.JOB_QUEUE
PROMPT Backup table: APP_DATA_OWNER.JOB_QUEUE_OLD
PROMPT ================================================================
