...
-- ==================================================================
-- DELTA LOAD: APP_DATA_OWNER.JOB_QUEUE_NEW
-- ==================================================================
-- Generated: 2025-10-25 21:07:53
-- Captures changes since initial load: 2025-10-25 21:07:53
-- ==================================================================
...
PROMPT Captures changes since: 2025-10-25 21:07:53
PROMPT ================================================================
...
DECLARE
    v_partition_column VARCHAR2(128) := 'CREATED_AT';
    v_delta_interval VARCHAR2(20) := 'last_day';
    v_cutoff_timestamp DATE;
    v_table_name VARCHAR2(128) := 'APP_DATA_OWNER.JOB_QUEUE';
    v_sql VARCHAR2(4000);
BEGIN
...
MERGE /*+ PARALLEL(4) */ INTO APP_DATA_OWNER.JOB_QUEUE_NEW tgt
USING (
    SELECT CREATED_AT, PROCESSED_AT, JOB_ID, PRIORITY, JOB_TYPE, JOB_STATUS
...
ON (tgt.CREATED_AT = src.CREATED_AT)
WHEN MATCHED THEN
    UPDATE SET 
WHEN NOT MATCHED THEN
    INSERT (CREATED_AT, PROCESSED_AT, JOB_ID, PRIORITY, JOB_TYPE, JOB_STATUS)
    VALUES (CREATED_AT, PROCESSED_AT, JOB_ID, PRIORITY, JOB_TYPE, JOB_STATUS);
