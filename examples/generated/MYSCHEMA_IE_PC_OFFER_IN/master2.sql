...
PROMPT
PROMPT Skipping Step 70: Old table kept as MYSCHEMA.IE_PC_OFFER_IN_OLD
PROMPT You can drop it later with: DROP TABLE MYSCHEMA.IE_PC_OFFER_IN_OLD PURGE;
...
PROMPT ================================================================
PROMPT New partitioned table: MYSCHEMA.IE_PC_OFFER_INPROMPT Backup table: MYSCHEMA.IE_PC_OFFER_IN_OLDPROMPT ================================================================
