-- ==================================================================
-- DROP OLD TABLE: MYSCHEMA.IE_PC_SEQ_OUT_OLD
-- ==================================================================
...
PROMPT ================================================================
PROMPT Table to drop: MYSCHEMA.IE_PC_SEQ_OUT_OLD
PROMPT ================================================================
PROMPT
...
-- Drop the old table
DROP TABLE MYSCHEMA.IE_PC_SEQ_OUT_OLD PURGE;

PROMPT ✓ Table MYSCHEMA.IE_PC_SEQ_OUT_OLD dropped successfully

-- Verify it's gone
SELECT COUNT(*) AS old_table_exists
FROM all_tables
WHERE owner = 'MYSCHEMA'
  AND table_name = 'IE_PC_SEQ_OUT_OLD';
