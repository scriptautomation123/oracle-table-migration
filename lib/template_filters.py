...
def format_column_list(columns: List[str], prefix: str = '', suffix: str = '', separator: str = ', ') -> str:
    """
...
def generate_match_condition(columns: List[str], left_alias: str = 'tgt', right_alias: str = 'src') -> str:
    """
...
def generate_update_set(columns: List[str], exclude_columns: List[str] = None, target_alias: str = 'tgt', source_alias: str = 'src') -> str:
    """
...
def format_lob_storage(lob_columns: List[str], tablespace: str = 'USERS', securefile: bool = True) -> str:
    """
