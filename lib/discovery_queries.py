...
class TableDiscovery:
    ...
    def save_config(self, config: Dict, output_file: str = 'migration_config.json'):
        ...
        print(f"  Edit this file to customize migration settings")
