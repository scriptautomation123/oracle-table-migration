-- ==================================================================
-- DATA LOAD: APP_DATA_OWNER.TEMP_CALCULATIONS -> APP_DATA_OWNER.TEMP_CALCULATIONS_NEW
-- ==================================================================
-- Generated: 2025-10-25 16:33:49
-- Estimated rows: 5 rows
...
@validation/count_table_rows.sql APP_DATA_OWNER TEMP_CALCULATIONS 5

-- Verify target table is empty using generic validation
@validation/count_table_rows.sql APP_DATA_OWNER TEMP_CALCULATIONS_NEW 0

-- Disable constraints on target (performance optimization)
@validation/disable_constraints.sql APP_DATA_OWNER TEMP_CALCULATIONS_NEW
...
INTO APP_DATA_OWNER.TEMP_CALCULATIONS_NEW
(
...
FROM 
    APP_DATA_OWNER.TEMP_CALCULATIONSORDER BY 
    CALC_TIMESTAMP  -- Order by partition key for efficient loading;
...
@validation/post_data_load_checks.sql APP_DATA_OWNER TEMP_CALCULATIONS_NEW TEMP_CALCULATIONS 5 4

-- Partition distribution summary (generic)
@validation/partition_distribution_summary.sql APP_DATA_OWNER TEMP_CALCULATIONS_NEW HASH
-- Re-enable constraints
@validation/enable_constraints.sql APP_DATA_OWNER TEMP_CALCULATIONS_NEW
