...
PROMPT ================================================================  
PROMPT Migration ID: MIG_TEMP_CALCULATIONS_20251025_163349
...
PROMPT Target: APP_DATA_OWNER.TEMP_CALCULATIONS (INTERVAL)
...
SELECT 
    CASE 
        ...
        WHEN EXISTS (SELECT 1 FROM user_part_tables WHERE table_name = 'TEMP_CALCULATIONS' AND partitioning_type = 'INTERVAL')
