-- ==================================================================
-- CREATE INDEXES: APP_DATA_OWNER.TEMP_CALCULATIONS_NEW
-- ==================================================================
-- Generated: 2025-10-25 16:33:49
-- Source: APP_DATA_OWNER.TEMP_CALCULATIONS
-- Index count: 1
-- Parallel degree: 4
-- ==================================================================
...
-- Index: SYS_C008303 (NORMAL)
PROMPT Creating index SYS_C008303_NEW...
CREATE UNIQUE INDEX "APP_DATA_OWNER"."SYS_C008303_NEW"
ON "APP_DATA_OWNER"."TEMP_CALCULATIONS_NEW" (CALC_ID)TABLESPACE USERSPCTFREE 10INITRANS 2MAXTRANS 255NOPARALLEL;
