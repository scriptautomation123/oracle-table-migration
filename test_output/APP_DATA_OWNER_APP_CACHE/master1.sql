...
PROMPT ================================================================  
PROMPT Migration ID: MIG_APP_CACHE_20251025_163349
...
PROMPT Target: APP_DATA_OWNER.APP_CACHE (INTERVAL)
...
SELECT 
    CASE 
        ...
        WHEN EXISTS (SELECT 1 FROM user_part_tables WHERE table_name = 'APP_CACHE' AND partitioning_type = 'INTERVAL')
