-- ==================================================================
-- DATA LOAD: APP_DATA_OWNER.APP_CACHE -> APP_DATA_OWNER.APP_CACHE_NEW
-- ==================================================================
-- Generated: 2025-10-25 16:33:49
-- Estimated rows: 20 rows
...
PROMPT ================================================================
PROMPT Source: APP_DATA_OWNER.APP_CACHE
...
@validation/count_table_rows.sql APP_DATA_OWNER APP_CACHE 20

-- Verify target table is empty using generic validation
@validation/count_table_rows.sql APP_DATA_OWNER APP_CACHE_NEW 0

-- Disable constraints on target (performance optimization)
@validation/disable_constraints.sql APP_DATA_OWNER APP_CACHE_NEW
...
INTO APP_DATA_OWNER.APP_CACHE_NEW
(
...
FROM 
    APP_DATA_OWNER.APP_CACHEORDER BY 
    EXPIRY_TIME  -- Order by partition key for efficient loading;
...
@validation/post_data_load_checks.sql APP_DATA_OWNER APP_CACHE_NEW APP_CACHE 20 4

-- Partition distribution summary (generic)
@validation/partition_distribution_summary.sql APP_DATA_OWNER APP_CACHE_NEW HASH
-- Re-enable constraints
@validation/enable_constraints.sql APP_DATA_OWNER APP_CACHE_NEW
