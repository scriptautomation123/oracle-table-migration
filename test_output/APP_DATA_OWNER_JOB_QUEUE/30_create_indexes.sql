-- ==================================================================
-- CREATE INDEXES: APP_DATA_OWNER.JOB_QUEUE_NEW
-- ==================================================================
-- Generated: 2025-10-25 16:33:49
-- Source: APP_DATA_OWNER.JOB_QUEUE
-- Index count: 1
-- Parallel degree: 4
-- ==================================================================
...
-- Index: SYS_C008306 (NORMAL)
PROMPT Creating index SYS_C008306_NEW...
CREATE UNIQUE INDEX "APP_DATA_OWNER"."SYS_C008306_NEW"
ON "APP_DATA_OWNER"."JOB_QUEUE_NEW" (JOB_ID)TABLESPACE USERSPCTFREE 10INITRANS 2MAXTRANS 255NOPARALLEL;
