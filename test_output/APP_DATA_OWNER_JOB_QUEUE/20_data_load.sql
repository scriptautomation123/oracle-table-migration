-- ==================================================================
-- DATA LOAD: APP_DATA_OWNER.JOB_QUEUE -> APP_DATA_OWNER.JOB_QUEUE_NEW
-- ==================================================================
-- Generated: 2025-10-25 16:33:49
-- Estimated rows: 4 rows
...
PROMPT ================================================================
PROMPT Source: APP_DATA_OWNER.JOB_QUEUE
PROMPT Target: APP_DATA_OWNER.JOB_QUEUE_NEW
...
@validation/count_table_rows.sql APP_DATA_OWNER JOB_QUEUE 4

-- Verify target table is empty using generic validation
@validation/count_table_rows.sql APP_DATA_OWNER JOB_QUEUE_NEW 0

-- Disable constraints on target (performance optimization)
@validation/disable_constraints.sql APP_DATA_OWNER JOB_QUEUE_NEW
...
INTO APP_DATA_OWNER.JOB_QUEUE_NEW
(
...
FROM 
    APP_DATA_OWNER.JOB_QUEUEORDER BY 
...
@validation/post_data_load_checks.sql APP_DATA_OWNER JOB_QUEUE_NEW JOB_QUEUE 4 4

-- Partition distribution summary (generic)
@validation/partition_distribution_summary.sql APP_DATA_OWNER JOB_QUEUE_NEW HASH
-- Re-enable constraints
@validation/enable_constraints.sql APP_DATA_OWNER JOB_QUEUE_NEW
