...
PROMPT ================================================================  
PROMPT Migration ID: MIG_SESSION_DATA_20251025_163349
...
PROMPT Target: APP_DATA_OWNER.SESSION_DATA (INTERVAL)
...
SELECT 
    CASE 
        ...
        WHEN EXISTS (SELECT 1 FROM user_part_tables WHERE table_name = 'SESSION_DATA' AND partitioning_type = 'INTERVAL')
